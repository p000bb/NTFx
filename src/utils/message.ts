...
export const message = {
  success: (msg: string, duration?: number) => messageManager.success(msg, duration),
  error: (msg: string, duration?: number) => messageManager.error(msg, duration),
  warning: (msg: string, duration?: number) => messageManager.warning(msg, duration),
